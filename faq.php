...
<br>
<table class=main width=750 border=0 cellspacing=0 cellpadding=0><tr><td class=embedded>
<h2>Why can't I connect? Is the site blocking me?<a name="conn" id="conn"></a></h2>
<table width=100% border=1 cellspacing=0 cellpadding=10><tr><td class=text>
<br>
...
<br>
<br>
<b>Alternate port (81)</b><a name="conn4"></a><br>
<br>
...
and replacing the announce url <?=$config['domain']?>:81 with <?=$config['domain']?>:80 or just <?=$config['domain']?>.<br>
<br>
...
<?=$config['domain']?>:80, not <?=$config['domain']?>. (If you're thinking about changing the number before the
...
<p align=right><font size=1 color=#004E98><b>FAQ edited 2004-05-23 (22:26 GMT)</b></font></p>
</td></tr></table>
